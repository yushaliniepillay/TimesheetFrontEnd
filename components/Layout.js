...
const sidebarNavigation = [
    { name: 'Home', href: '/index', icon: HomeIcon, current: false },
    { name: 'Project', href: '/project/viewProject', icon: FolderIcon, current: true },
...
export default function Layout({ children }) {
    ...
    return (
        <div>
            {/* <p>this is ht elayour</p> {children} */}
            <div className="flex h-full">
                ...
                <div className="flex flex-col flex-1 overflow-hidden">
                    ...
                    {/* Main content */}
                    <div className="over flow-hidden flexflex-1">
                        {children}
